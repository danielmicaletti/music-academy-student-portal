    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('play_level', models.CharField(blank=True, choices=[('1', 'White'), ('2', 'Yellow'), ('3', 'Orange'), ('4', 'Green'), ('5', 'Blue'), ('6', 'Purple'), ('7', 'Red'), ('8', 'Brown'), ('9', 'Black')], default='1', max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='plan_section', to='users.StudentPlan')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('practice_category', models.CharField(blank=True, choices=[('LEAD_TECHNIQUE', 'Lead Technique'), ('RHYTHM_TECHNIQUE', 'Rhythm Technique'), ('FRETBOARD', 'Fretboard Knowledge'), ('THEORY', 'Music Theory Concepts'), ('REPERTOIRE', 'Songs and Repertoire'), ('CREATIVITY', 'Creativity')], max_length=20, null=True)),
